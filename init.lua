...
-- Decrease update time (for better CursorHold performance)
...
require('lazy').setup({
  ...
  -- LSP Plugins
  require 'kickstart.plugins.lspconfig.lspconfig',

  -- Custom optimized plugins (overrides kickstart defaults for better performance)
